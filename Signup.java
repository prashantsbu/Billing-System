...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        setLayout(null); // Layout must be set before adding components
            ...
            public void focusLost(FocusEvent e) {
                try {
                    ...
                    ResultSet resultSet = c.statement.executeQuery(
                            "SELECT * FROM Signup WHERE meter_no = '" + meterText.getText() + "'");
                    if (resultSet.next()) {
            ...
            try {
                ...
                if (sloginAs.equals("Admin")) {
                    query = "INSERT INTO Signup (meter_no, username, name, password, usertype) " +
                            "VALUES ('" + semployer + "', '" + susername + "', '" + sname + "', '" + spassword + "', '" + sloginAs + "')";
                } else {
                    query = "UPDATE Signup SET username = '" + susername + "', password = '" + spassword + "', usertype = '" + sloginAs + "' " +
